...
export default function AIChatPanel({ roundId }: AIChatPanelProps) {
  ...
  const handleSubmit = async () => {
    ...
    await queryClient.invalidateQueries({ queryKey: ["thesis-chat-messages", user.id, roundId] });
    ...
    try {
      ...
      setTimeout(() => {
        queryClient.invalidateQueries({ queryKey: ["thesis-chat-messages", user.id, roundId] });
      ...
      <div className="p-3 border-t border-border">
        <div className="relative">
          <Textarea
            ...
            placeholder="Ask Thesis to add investors, create memos..."
            rows={2}
