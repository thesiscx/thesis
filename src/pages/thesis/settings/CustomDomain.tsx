            ...
            <CardContent className="space-y-4">
              <div className="flex items-start gap-3 p-4 rounded-lg bg-muted/30 border border-dashed">
                ...
                <div className="text-sm text-muted-foreground">
                  ...
                  <p>Custom domain configuration will be available in a future update. For now, your investors can access documents via your Thesis URL.</p>
                </div>
              </div>
