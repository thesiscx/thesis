  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <p className="text-muted-foreground mb-12">Simple, transparent pricing for founders.</p>
        ...
        <div className="border border-border rounded-lg p-6">
          ...
          <p className="text-sm text-muted-foreground mb-6">Everything you need to run your raise, end to end.</p>
        ...
        <p className="text-center text-sm text-muted-foreground mt-12">Questions? Reach out at contact@thesis.run</p>
      </div>
    </div>
  );
}
