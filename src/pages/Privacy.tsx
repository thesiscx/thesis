        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6 text-muted-foreground">
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm leading-relaxed">
              We collect information you provide directly, including: account information (name, email), company
              information (name, website, description), investment documents and memos you create, and files you upload
              to the platform.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm leading-relaxed">
              We use your information to: provide and improve the Service, personalize your experience, communicate with
              you about the Service, analyze usage patterns, and ensure the security of your account and data.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm leading-relaxed">
              ...
              operating the platform, when required by law, or with your explicit consent. Investor-facing content is
              only shared with parties you explicitly authorize via share links or access keys.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm leading-relaxed">
              We use cookies and similar technologies to maintain your session, remember preferences, and analyze how
              the Service is used. You can control cookie settings through your browser preferences.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm leading-relaxed">
              The Service may integrate with third-party services (such as authentication providers). Your use of these
              services is governed by their respective privacy policies. We encourage you to review those policies.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm leading-relaxed">
              You have the right to: access your personal data, correct inaccurate data, request deletion of your data,
              export your data in a portable format, and opt out of marketing communications.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm leading-relaxed">
              ...
              updated policy and updating the "Last updated" date.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm leading-relaxed">
              For questions about this Privacy Policy, please contact us at contact@thesis.run.
            </p>
          </section>
        </div>
      </div>
